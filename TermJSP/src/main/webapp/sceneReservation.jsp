...
<!-- BREADCRUMB -->
		<div id="breadcrumb" class="section">
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-12">
						<h3 class="breadcrumb-header">현장 예매</h3>
						<ul class="breadcrumb-tree">
							<li><a href="#">관리자 페이지</a></li>
							<li class="active">현장 예매</li>
						</ul>
					</div>
				</div>
				<!-- /row -->
			...
			<div class="container">
				...
				<div class="row">
         		...
         		<h3>고객 아이디</h3>
                	...
                	<button class="search-btn" onclick="userIDSubmit()">입력</button>
				   </div>
						<!-- Billing Details -->
					...
					<div class="col-md-5 order-details">
						...
						<div class="order-summary">
							...
							<ul>
                                    ...
                                    <br>
                               <p>보유 포인트: <strong id="user-point"></strong></p>
                        <br><br>
		...
		<script>
			...
			function userIDSubmit() {
            	...
            	$("#user-id").val(userID);
            	$.post("getUserPoint.jsp",
            			{
            				"userID":userID
            			},
            			function(data,status) {
            				$("#user-point").html(data);
            			}
            	);
            }
